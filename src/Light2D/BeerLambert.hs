module Light2D.BeerLambert (
    generateBeerLambertImage, 
    dumpBeerLambertFile
) where
...
scene x y = a .|. b where
    a = Result (circleSDF x y (-0.2) (-0.2) 0.1) 10.0 0.0 0.0 0.0
    b = Result (boxSDF x y 0.5 0.5 0.0 0.3 0.2) 0.0 0.2 1.5 4.0
...
generateBeerLambertImage :: Image PixelRGB8
generateBeerLambertImage = generateImage pixelFunc width height where
...
dumpBeerLambertFile :: IO ()
dumpBeerLambertFile = writePng "img/beerLambert.png" generateBeerLambertImage
